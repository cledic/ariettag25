...
int PWMChannel_SetPeriod( char* chnl, char* period)
{
    ...
    sprintf( buff, "/sys/class/pwm/pwmchip0/pwm%s/enable", chnl);
    ...
    sprintf( buff, "/sys/class/pwm/pwmchip0/pwm%s/period", chnl);
...
int PWMChannel_SetDutyCycle( char* chnl, char* duty)
{
    ...
    sprintf( buff, "/sys/class/pwm/pwmchip0/pwm%s/duty_cycle", chnl);
